module github.com/itoam/pulumi-openstatus/provider
...
require (
	github.com/itoam/terraform-provider-openstatus/shim v0.0.0-00010101000000-000000000000
	github.com/pulumi/pulumi-terraform-bridge/v3 v3.96.0
	github.com/pulumi/pulumi/pkg/v3 v3.140.0
)

replace github.com/itoam/terraform-provider-openstatus/shim => ./shim
...
require (
	...
	github.com/itoam/terraform-provider-openstatus v0.0.0-20241204152302-ad9260f03f1d // indirect
